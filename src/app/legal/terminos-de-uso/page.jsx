    ...
    <main>
      <section className="relative pb-spacing-4 px-spacing-4 sm:px-spacing-28 bg-gradient-primary text-justify overflow-hidden">
        ...
        <p className="p-custom-legal">
          Bienvenido a BIEN SEGUROS. Al utilizar nuestro sitio web, usted acepta cumplir con los siguientes
        ...
        <p className="p-custom-legal">
          ...
          imágenes, clips de audio y software, es propiedad de BIEN SEGUROS. o de sus proveedores de
        ...
        <p className="p-custom-legal">
          En la medida permitida por la ley, BIEN SEGUROS. no será responsable de ninguna pérdida o daño
